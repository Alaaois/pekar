...
use App\Infrastructure\Persistence\User\InMemoryCartRepository;
use Tests\TestCase;
...
class InMemoryUserRepositoryTest extends TestCase
{
    public function testFindAll()
    {
        ...
        $userRepository = new InMemoryCartRepository([1 => $user]);
    ...
    public function testFindAllUsersByDefault()
    {
        ...
        $userRepository = new InMemoryCartRepository();
