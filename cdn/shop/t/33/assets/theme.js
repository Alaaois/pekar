...
Line 782:2 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 783:15 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 822:8 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 826:11 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 830:20 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 837:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 941:2 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 942:15 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 957:8 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 1004:9 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
(function ($) {
    ...
    _._callSectionWith = function (section, method, container, thisContext) {
      if (typeof section[method] === "function") {
        try {
          ...
          console.warn(
            "Theme warning: '"
              .concat(method, "' failed for section '")
              .concat(sectionType, "'")
          );
  ...
  theme.suffixIds = function (container, suffix) {
    ...
    container.querySelectorAll("[id]").forEach((el) => {
      ...
      refAttrs.forEach((attr) => {
        container
          .querySelectorAll("[".concat(attr, '="').concat(oldId, '"]'))
          .forEach((refEl) => {
  ...
  theme.renderUnitPrice = function (
    unit_price,
    ...
    if (unit_price && unit_price_measurement) {
      ...
      unitPriceHtml += '<span class="unit-price__price theme-money">'.concat(
        theme.Shopify.formatMoney(unit_price, money_format),
        "</span>"
      );
      unitPriceHtml += '<span class="unit-price__separator">'.concat(
      ...
      unitPriceHtml += '<span class="unit-price__unit">'.concat(
        unit,
        "</span>"
      );
      unitPriceHtml += "</div>";
  ...
  class ccPopup {
    ...
    close(callback) {
      ...
      var $visibleFreezePopups = $("." + this.cssClasses.visible).filter(() => {
  ...
  class CustomSelectInstance {
    ...
    setButtonWidth() {
      ...
      var optionWidth = Math.ceil(
        this.selectedOption.getBoundingClientRect().width
      );

      this.button.style.width = "".concat(
        optionWidth - optionPadding + buttonPadding + buttonBorder,
        "px"
      );
    }
    ...
    handleSelectOption(e) {
      var matchingOption = [...this.options].find(
  ...
  class ModalInstance {
    constructor(container) {
      ...
      this.contentElement = document.querySelector(
        container.dataset.ccModalContentelement
      );
    ...
    open() {
      ...
      var modalElementFragment = document
        .createRange()
  ...
  theme.VideoManager = new (function () {
    ...
    _._loadYoutubeVideos = function (container) {
      $(
        ...
        var ytURLSearchParams = new URLSearchParams(
        ...
        _.videos.videoData[containerId] = {
          ...
          seekTo: (to) =>
            $videoElement[0].contentWindow.postMessage(
              '{"event":"command","func":"seekTo","args":['.concat(
                to,
                ",true]}"
              ),
              "*"
      ...
      $('.video-container[data-video-type="mp4"]:not(.video--init)', container)
        ...
        .each(function () {
          ...
          var $videoElement = $('<div class="video-container__video-element">')
            ...
            .appendTo($(".video-container__video", this));
          var autoplay = $(this).data("video-autoplay");
          var isBackgroundVideo = $(this).hasClass(
    ...
    this.functions = {
      buildIndex: function buildIndex() {
        ...
        while (
          ...
          // build index UI
          if (indexContainer) {
            var currentElementHeading = currentElement.querySelector(
            ...
            if (currentElementHeading) {
              ...
              var html =
                '\n              <div class="faq-index-item">\n                <a class="faq-index-item__link" href="#'
                  ...
                  .concat(tve.values.title, "</a>\n              </div>");

              var htmlFragment = document
                .createRange()
                .createContextualFragment(html);
      ...
      resizeIndex: function resizeIndex() {
        var stickyContainer = this.container.querySelector(
      ...
      handleIndexClick: function handleIndexClick(evt) {
        if (evt.target.classList.contains("faq-index-item__link")) {
          ...
          var stickyHeight = getComputedStyle(
  ...
  theme.loadCarousels = function (container) {
    return $(".carousel", container).each(function () {
      ...
      $this
        ...
        .on("click.themeCarousel", ".prev, .next", function (e) {
          e.preventDefault();
          var carousel = $(this)
            .closest(".collection-slider")
            .find(".owl-carousel")
      ...
      var fixedMode =
        $this.hasClass("carousel--fixed-grid-mode") ||
        !$(this).closest(".container--no-max").length;
      if (fixedMode) {
        $this.addClass("carousel--fixed-grid-mode");
        var desktopNumPerRow = parseInt(
          $this[0].className.match(/per-row-(.)/)[1]
        );
        var forcedNumPerRow = false;
        if ($this[0].className.indexOf("carousel--per-row-") > -1) {
          forcedNumPerRow = parseInt(
            $this[0].className.match(/carousel--per-row-(.)/)[1]
          );
        }
        carouselOptions = {
          margin: 0,
      ...
      var loadCarousel = function loadCarousel() {
        ...
        $this.on("initialized.owl.carousel", function () {
          ...
          theme.ProductBlockManager.loadImages(
            $this.closest("[data-section-type]")
          );
          ...
          function (evt) {
            ...
            setTimeout(function () {
              ...
              $this
                .closest(".collection-slider")
                .find(".prev, .next")
                .toggleClass("owl-btn-disabled", !stageIsPartiallyOffScreen);
            }, 10);
          }
        );
  ...
  theme.toggleLinkDropdownButton = function (evt) {
    ...
    var newWidth = null,
      ...
      isLeftAligned = $btn
        ...
        .hasClass("link-dropdown--left-aligned");
    if (!isLeftAligned) {
      if (doExpand) {
        ...
        newWidth -= parseInt(
          $optsBox
            .find(".link-dropdown__link:first")
            .css("padding-inline-start")
        );
      } else {
        newWidth =
          parseInt($btn.css("padding-inline-end")) +
          $btn.find(".link-dropdown__button-text").width() +
          1;
      }
      setTimeout(function () {
  ...
  theme.avoidUnecessaryOrphans = function (element) {
    if (theme.settings.avoid_orphans) {
      ...
      if (
        ...
        innerTextSplit[innerTextSplit.length - 1].length +
          innerTextSplit[innerTextSplit.length - 2].length <
          20 // last two words aren't particularly long together
      ) {
        ...
        if (html.indexOf('<span class="orphan-join">') < 0) {
          ...
          if (
            theme.measureTextInsideElement(
              splitHtml[splitHtml.length - 1].replace(/<[^>]*?>/g, "") +
                " " +
                lastItem.replace(/<[^>]*?>/g, ""),
              element
  ...
  theme.validateProductForm = function ($formContainer) {
    ...
    if (!$formContainer.find(".original-selector").val()) {
      ...
      !theme.OptionManager.getCurrentVariantData($formContainer).available
    ) {
      // variant unavailable
      return false;
    } else {
  ...
  theme.suffixIds = (container, prefix) => {
    ...
    var _loop = function _loop(i) {
      container
        .querySelectorAll("[".concat(suffixCandidates[i], "]"))
        .forEach((el) =>
          el.setAttribute(
            suffixCandidates[i],
  ...
  theme.mergeNodes = (newContent, targetContainer) => {
    try {
      ...
      newContent.querySelectorAll("[data-merge]").forEach((newEl) => {
        var targetEl = targetContainer.querySelector(
          '[data-merge="'.concat(newEl.dataset.merge, '"]')
        );
        if (
      ...
      newContent
        ...
        .forEach((newEl) => {
          var targetEl = targetContainer.querySelector(
            '[data-merge-attributes="'.concat(
              newEl.dataset.mergeAttributes,
              '"]'
            )
          );
      ...
      newContent.querySelectorAll("[data-merge-list]").forEach((newList) => {
        var targetList = targetContainer.querySelector(
          '[data-merge-list="'.concat(newList.dataset.mergeList, '"]')
        );
        var targetListItems = Array.from(
          targetList.querySelectorAll("[data-merge-list-item]")
        );
        var newListItems = Array.from(
          newList.querySelectorAll("[data-merge-list-item]")
        );

        // remove
        targetListItems.forEach((targetListItem) => {
          var matchedItem = newListItems.find(
            (item) =>
        ...
        var _loop2 = function _loop2() {
          ...
          var matchedItem = targetListItems.find(
            (item) =>
  ...
  theme.loadLazyBGSet = function (container) {
    $("[data-lazy-bgset-src]", container).each(function () {
      ...
      srcset += ""
        .concat(masterSrc, " ")
        .concat(masterWidth, "w ")
        .concat(masterHeight, "h");
      $(this)
  ...
  theme.ProductBlockManager = new (function () {
    ...
    _.incrementActiveImage = function ($images, increment) {
      var index = Math.max(
        $images.filter(".product-block__image--active:first").index(),
        0
      );
    ...
    _.setActiveImage = function ($images, index) {
      ...
      _.lazyloadImage($newActive, () => {
        ...
        // set new hover image
        var $hoverImage = $(_.getImageAt($images, index + 1)).addClass(
          "product-block__image--show-on-hover"
        );
        $hoverImage
          .siblings()
          .removeClass("product-block__image--show-on-hover");
      ...
      if ($(".image-cont--with-secondary-image", container).length) {
        ...
        $(container).on(
          ...
          function (evt) {
            ...
            _.incrementActiveImage(
              $images,
              $(evt.currentTarget).hasClass("image-page-button--next") ? 1 : -1
            );
            // preload the rest
        ...
        if (
          $(".image-cont--with-secondary-image:first", container).closest(
          ...
          $(container).on(
            ...
            function (evt) {
              ...
              var nextImage = evt.currentTarget.querySelector(
          ...
          $(container).on(
            ...
            function (evt) {
              if (theme.productBlockTouchTracking) {
                if (
                  Math.abs(
                    evt.touches[0].clientY - theme.productBlockTouchStartY
                  ) < 30
                ) {
                  var deltaX =
  ...
  if (theme.settings.after_add_to_cart === "notification") {
    var AddedNotification = class extends HTMLElement {
      ...
      dismissOthers() {
        document
          .querySelectorAll(".added-notification")
      ...
      setProductTitle(productTitle) {
        this.querySelector(".added-notification__message-title").innerText =
          productTitle;
      }
      ...
      display() {
        ...
        this.querySelector(".added-notification__close").addEventListener(
          "click",
          this.dismiss.bind(this)
        );
        if (theme.settings.cart_type === "drawer") {
          var cartLinks = this.querySelectorAll(
            '.added-notification__message-text a[href$="/cart"]'
          );
  ...
  theme.applyAjaxToProductForm = function ($formContainer) {
    $formContainer.find("form.product-purchase-form").each(function () {
      ...
      $form.on("submit", function (evt) {
        ...
        // Ajax-add
        if (
          theme.settings.after_add_to_cart !== "no-js" &&
          $formContainer.is('[data-ajax-add-to-cart="true"]')
        ) {
          evt.preventDefault();
          ...
          $.post(
            ...
            theme.addedToCartHandler.bind($form),
            "json"
          ).fail(function (data) {
            //Enable add button
            $form
  ...
  theme.addedToCartHandler = function (response) {
    ...
    $(this)
      ...
      .each(function () {
        ...
        $btn
          .addClass("btn--added")
          .text(theme.strings.products_product_added_to_cart);
        clearTimeout($(this).data("revertAddToCartTextTimeoutID"));
        $btn.data(
  ...
  var CartForm = class extends HTMLElement {
    ...
    refresh(openDrawer) {
      ...
      fetch(
        ""
          .concat(window.Shopify.routes.root, "?section_id=")
    ...
    adjustItemQuantity(item, change) {
      ...
      if (
        ...
        quantityInput.value = newQuantity;
        theme.showQuickPopup(
          theme.strings.cart_general_quantity_too_high.replace(
            "[QUANTITY]",
            quantityInput.max
          ),
          $(quantityInput)
  ...
  window.customElements.define("cc-cart-cross-sell", CCCartCrossSell); // must be after product-blocks.js
    ...
    this.functions = {
      ...
      ajaxLoadUrl: function ajaxLoadUrl(url, noPushState) {
        ...
        if (this.$container[0].dataset.filterSectionId) {
          url +=
            (url.indexOf("?") >= 0 ? "&" : "?") +
            "section_id=".concat(this.$container[0].dataset.filterSectionId);
        }
        ...
        this.currentAjaxLoadUrlFetch = $.get(
          ...
          function (data) {
            ...
            if (getComputedStyle(scrollContainer).overflow === "auto") {
              ...
              for (var i = 1; i < allFilterChildren.length; i++) {
                if (allFilterChildren[i].offsetTop) {
                  // if above fold
                  if (
                    allFilterChildren[i].offsetTop < scrollContainer.scrollTop
                  ) {
                    // if below previously assigned element, assign
                    if (
                      allFilterChildren[i].offsetTop >
                      elAboveScrollTop.offsetTop
                    ) {
              ...
              if (elAboveScrollTop.offsetTop === 0) {
                ...
                for (var attrName of elAboveScrollTop.getAttributeNames()) {
                  if (attrName === "class") {
                    ...
                    elAboveScrollTopData.selector += "["
                      .concat(attrName, '="')
                      .concat(
                        CSS.escape(elAboveScrollTop.getAttribute(attrName)),
                        '"]'
                      );
                  }
                }
            ...
            // replace contents
            var $newAjaxContainers = $("<div>".concat(data, "</div>")).find(
            ...
            if (elAboveScrollTopData) {
              this.$container[0]
                .querySelectorAll(elAboveScrollTopData.selector)
                .forEach((el) => {
            ...
            var scrollToY =
              $("[data-ajax-scroll-to]:first", this.$container).offset().top -
        ...
        (evt) => {
          if (this.allowAutoApplyHideUnavailable) {
            if (
              ...
              (evt.currentTarget.type === "text" && evt.currentTarget.value)
            ) {
              var toEnable = this.$container.find(
  ...
  theme.buildGalleryViewer = function (config) {
    ...
    var $allContainer = $(
      ...
      $controlsContainer = $('<div class="gallery-viewer__controls">').appendTo(
        $allContainer
      ),
      $close = $(
    ...
    var panZoomImageFromCoordinate = function panZoomImageFromCoordinate(
      inputX,
      inputY
    ) {
      ...
      if (doPanX || doPanY) {
        ...
        if (doPanY) {
          var offsetMultiplierY =
            ($currentZoomImage.height() - $allContainer.height()) / 2 / midY;
    ...
    var alterCurrentPanBy = function alterCurrentPanBy(x, y) {
      ...
      var panXMax =
        ($currentZoomImage[0].naturalWidth * currentTransform.zoom -
          $allContainer.width()) /
        2.0;
      ...
      var panYMax =
        ($currentZoomImage[0].naturalHeight * currentTransform.zoom -
          $allContainer.height()) /
        2.0;
    ...
    var alterCurrentTransformZoomBy = function alterCurrentTransformZoomBy(
      delta
    ) {
      ...
      currentTransform.zoom = Math.max(
    ...
    var updateImagePosition = function updateImagePosition() {
      $currentZoomImage.css(
        "transform",
        "translate3d("
          .concat(currentTransform.panX, "px, ")
          .concat(currentTransform.panY, "px, 0) scale(")
          .concat(currentTransform.zoom, ")")
      );
    };
      ...
      function (evt) {
        ...
        $currentZoomImage
          .on("load", function () {
            $(this)
              .parent()
              .removeClass("gallery-viewer__zoom-container--loading");
            $(this).off("load");
            $(this).css({
              visibility: "",
    ...
    $allContainer.on("wheel.galleryViewer", function (evt) {
      ...
      if (evt.originalEvent.deltaY != 0) {
        alterCurrentTransformZoomBy(
          evt.originalEvent.deltaY * wheelZoomMultiplier
        );
      }
    });
    ...
    var $focusThumb = $thumbContainer
      .find(".gallery-viewer__thumb:eq(" + currentIndex + ")")
      .trigger("select");
  ...
  theme.Navigation = {
    init: function init(options) {
      ...
      var $mobileDrawerFooter = $(
        '<div class="mobile-navigation-drawer__footer">'
      ).appendTo($mobileDrawer);
      $mobileDrawerFooter.append(
        $(".announcement-bar .inline-menu").clone().removeClass("desktop-only")
      );
      $mobileDrawerFooter.append(
      ...
      var mobileSocialLinks = $(".announcement-bar .social-links")
        .clone()
        .removeClass("desktop-only")[0];
      var mobileSocialLinksCustomIconToSwap = document.querySelector(
        ".announcement-bar .js-replacement-custom-icon"
      );
      if (mobileSocialLinksCustomIconToSwap) {
        mobileSocialLinks.querySelector(
          ".social-custom"
        ).parentElement.innerHTML =
          mobileSocialLinksCustomIconToSwap.content.firstElementChild.cloneNode(
            true
          ).innerHTML;
      }
      ...
      $mobileDrawer.on(
        ...
        function (evt) {
          ...
          $(this)
            ...
            .css({
              top:
                Math.ceil($(".navigation__mobile-header:last").height() + 1) +
                "px",
            });
      ...
      $mobileDrawer.on(
        ...
        function (evt) {
          ...
          if (doOpen) {
            ...
            var $childContainer = $(this).siblings(
              ".navigation__tier-3-container"
            );
            $childContainer.css(
              "height",
              $childContainer.children().outerHeight()
            );
          } else {
      ...
      $nav.on(
        ...
        function (evt, data) {
          ...
          if (evt.type == "mouseenter") {
            ...
            var $openSiblings = $dropdownContainer.siblings(
              ".navigation__item--show-children"
            );

            // close all menus but last opened
            $openSiblings
              .not($navLastOpenDropdown)
          ...
          if (evt.type == "touchstart") {
            ...
            if (evt.timeStamp - $(this).data("touchstartedAt") < 1000) {
              ...
              if (
                ...
                $(".navigation:first .navigation__item--show-children").trigger(
                  "mouseleave"
                );
                // trigger open
      ...
      var keydownHandler = function keydownHandler(evt) {
        if (evt.which == 13) {
          ...
          $parent.trigger(
            $parent.hasClass("navigation__item--show-children")
              ? "mouseleave"
              : "mouseenter"
          );
          return false;
      ...
      if (options.proxyTier1Nav) {
        ...
        $(options.proxyTier1Nav).on(
          "mouseenter touchstart",
          ".navigation__item--with-small-menu",
          function (evt) {
            var $dropdown = $(
              $(".navigation__tier-1 > .navigation__item", $nav)[
                $(this).index()
              ]
            ...
            if (document.querySelector("html[dir=rtl]")) {
              $dropdown.css(
                "right",
                $dropdown[0].offsetParent.clientWidth -
      ...
      if (options.proxyTier1Nav.length) {
        options.proxyTier1Nav[0].addEventListener(
          "mouseenter",
    ...
    destroy: function destroy($nav, $proxyTier1Nav) {
      $nav
        .add($proxyTier1Nav)
        .off("click mouseenter mouseleave touchstart touchend keydown");
  ...
  theme.initProductGallery = function (container) {
    ...
    /// Variant grouping
    if (
      $gallery.data("variant-image-grouping") &&
      $gallery.data("variant-image-grouping-option-index") !== ""
    ) {
      var productData = theme.OptionManager.getProductData(
          $gallery.closest(".product-detail").find(".product-form")
        ),
        groupingOptionIndex = $gallery.data(
          "variant-image-grouping-option-index"
        );
        ...
        productData.variants.forEach((variant) => {
          if (variant.featured_media && variant.featured_media.id == media.id) {
            if (!optionNameMediaMap[variant.options[groupingOptionIndex]]) {
              optionNameMediaMap[variant.options[groupingOptionIndex]] =
                media.id;
            }
          }
        });
      ...
      $(".gallery", container).on(
        ...
        function (e) {
          ...
          if (e.type != "selectFromSlick") {
            ...
            var _$slideshow = $(this)
              .closest(".gallery")
              .find(".slideshow.slick-slider");
            if (_$slideshow) {
              var index = _$slideshow
                .find('.slide[data-media-id="' + mediaId + '"]')
                .index(); // current index including filters
            ...
            var shelfStart = $carouselItem
              .parent()
              .children(".active:first")
              .index();
            ...
            if (currentIndex < shelfStart) {
              ...
              $carouselItem
                ...
                .trigger("to.owl.carousel", currentIndex);
              ...
              $carouselItem
                ...
                .trigger(
                  "to.owl.carousel",
                  Math.max(0, currentIndex - carouselVisibleItemCount + 1)
                );
            }
          }
        }
  ...
  theme.OptionManager = new (function () {
    ...
    _._getVariantOptionElement = function (variant, $container) {
      return $container.find(
        'select[name="id"] option[value="' + (variant ? variant.id : "") + '"]'
      );
    };
    ...
    _.getCurrentVariantData = function ($productForm) {
      return _.getVariantFromId(
        $productForm,
        $productForm.find(_.selectors.primaryVariantIdInput).val()
      );
    };
    ...
    _.updateTransferNotice = function (variant, $container) {
      var transferData = _._getVariantOptionElement(variant, $container).data(
        "inventory-transfer"
      );
      if (transferData) {
        $container
        ...
        if (variant && variant.available) {
          if (
            ...
            var productData = _.getProductData(
              $backorder.closest(".product-form")
            );
            $backorder
    ...
    _.updateContainerStatusClasses = function (variant, $container) {
      ...
      $container.toggleClass(
        ...
        variant && variant.available && variant.compare_at_price > variant.price
      );
    };
            ...
            .each(function () {
              if ($(this).data("selector-type") === "listed") {
                ...
                selectedOptions.push(
                  $(this).find('.js-option[aria-selected="true"]').data("value")
                );
              }
            });
        ...
        $(this).on(
          ...
          function (e) {
            ...
            if (variant && variant.featured_media) {
              ...
              var matchesRequired = e.detail.selectedOptions.filter(
                (o) => o && o.length > 0
              ).length;
              ...
              this.querySelectorAll(".opt-label__text").forEach((el) => {
                if (el.innerText == value) {
                  var input = document.getElementById(
                    el.parentElement.getAttribute("for")
                  );
                  if (input) {
                    input.checked = true;
                    input.dispatchEvent(
  ...
  theme.loadQuickbuy = function () {
      ...
      $(componentContainer)
        ...
        .each(function () {
          $(this)
            ...
            .split(",")
            .forEach((component) => {
              $(document).trigger("cc:component:unload", [
                component,
                componentContainer,
              ]);
            });
        ...
        if (block) {
          ...
          if (block.classList.contains("expanded")) {
            var targetHeight = $(qbInner).outerHeight(),
              expandedSiblings = [...block.parentNode.children].filter(
                (child) => {
                  return (
                    child !== block && child.classList.contains("expanded")
                  );
                }
              ),
          ...
          if ($block.toggleClass("expanded").hasClass("expanded")) {
            ...
            if ($slider.length > 0) {
              ...
              if (noneExpanded) {
                ...
                $(".product-form", $quickbuyCont).trigger(
                  "unload-product-form"
                );
            ...
            theme.currentQuickbuyRequest = $.get(url, function (response) {
              var $newDetail = $("<div>" + response + "</div>").find(
                ".quickbuy-content"
              );
              ...
              $newDetail
                .find(".detail .title")
                .wrapInner($("<a>").attr("href", productUrl));
              $newDetail
                .find(".show-gallery")
              ...
              $newDetail
                .find(".only-in-quickbuy")
                .removeClass("only-in-quickbuy");
              $newDetail
            ...
            if (scrollMode == "qb") {
              ...
              if ($slider.length > 0) {
                ...
                var offsetTop =
                  typeof $block.data("offsetTop") != "undefined"
                    ? $block.data("offsetTop")
                    : $block.offset().top;
                $("html:not(:animated),body:not(:animated)").animate(
            ...
            if ($slider.length > 0) {
              ...
              $quickbuyCont
                .stop()
                .animate({ height: 0 }, droppyDownAnimSpeed, function () {
                  // remove details
                  $detailCont.empty();
                });
            } else {
    ...
    function saveCollectionPageData() {
      $(".collection-listing").each(function () {
        ...
        var blockHeight = Math.min(
          $blocks.first().outerHeight(),
          $($blocks[1]).outerHeight()
        );
    ...
    $(document).on("click", ".sharing a", function (e) {
      ...
      if ($parent.hasClass("twitter")) {
        ...
        var width = 575,
          ...
          opts =
            "status=1, toolbar=0, location=0, menubar=0, directories=0, scrollbars=0" +
            ",width=" +
            width +
            ",height=" +
            height +
  ...
  theme.CartDrawerSection = new (function () {
    this.onSectionLoad = function (container) {
      ...
      container
        .querySelectorAll(".cc-popup-close")
        .forEach((el) => el.addEventListener("click", this.boundClose));
      container
        .querySelector(".cc-popup-background")
  ...
  theme.CollectionTemplateSection = new (function () {
    this.onSectionLoad = function (container) {
      ...
      var $subcollectionGallery = $(
        ".subcollection-links--gallery .gallery",
        container
      );
      $subcollectionGallery
        ...
        .slick({
          ...
          slidesToShow: Math.min(
            4,
            $(".subcollection-links--gallery .gallery__item", container).length
          ),
          slidesToScroll: 1,
          useTransform: true,
          arrows: true,
          ...
          responsive: [
            {
              ...
              settings: {
                slidesToShow: Math.min(
                  3,
                  $(".subcollection-links--gallery .gallery__item", container)
                    .length
                ),
              },
            },
            {
              breakpoint: 768,
              settings:
                $subcollectionGallery.data("mobile-item-count") == "hide"
                  ? "unslick"
                  : {
                      slidesToShow:
                        $subcollectionGallery.data("mobile-item-count"),
                    },
            },
          ],
        });
    ...
    this.functions = {
      truncateButtonSubcollections: function truncateButtonSubcollections() {
        ...
        if ($subcollections.css("display") == "flex") {
          ...
          $subcollections.find(".subcollection-links__expander").length
        ) {
          $subcollections
            .find(".subcollection-links__expander")
            .siblings()
            .show();
  ...
  theme.GallerySection = new (function () {
    this.onSectionLoad = function (container) {
      ...
      // Tidier typography
      $(".overlay-text__title, .overlay-text__rte", container).each(
        function () {
      ...
      if ($liveSearchContainer.length) {
        ...
        $(container).on(
          ...
          function () {
            ...
            if (
              valueToSearch.length > 2 &&
              valueToSearch != $(this).data("oldval")
            ) {
              ...
              searchTimeoutID = setTimeout(function () {
                ...
                currReqObj = $.ajax({
                  ...
                  success: function success(response) {
                    ...
                    if (!theme.Shopify.features.predictiveSearch) {
                      $resultsList = $("<div>" + response + "</div>").find(
                    ...
                    $resultsProducts.children()[0].className =
                      $resultsList[0].className;
                    ...
                    $resultsList
                      ...
                      .each(function () {
                        ...
                        $('<div class="main-search-result__text">')
                          .text($(this).find(".page-block__title").text())
                          .appendTo($item);
                    ...
                    var areProducts =
                        $resultsProducts.find(".main-search-result:first")
                          .length > 0,
                      arePages =
                        $resultsPages.find(".main-search-result:first").length >
                        0;
                    if (areProducts || arePages) {
                      ...
                      $searchContainer.toggleClass(
                        ...
                        $resultsProducts.find(".product-block").length > 4
                      );
                      if (areProducts) {
    ...
    this.onSectionLoad = function (container) {
      ...
      if ($("[data-store-availability-container]", container).length) {
        this.storeAvailability = new theme.StoreAvailability(
          $("[data-store-availability-container]", container)[0]
        );
      }
      ...
      $(".slideshow", container).each(function () {
        ...
        $(this)
          ...
          .on("beforeChange", function (event, slick, currentSlide) {
            if (
              $(this).data("transition") === "slide_fade" ||
  ...
  $(function ($) {
    ...
    $(document).on("click", "a[data-toggle-target]", function (e) {
      ...
      var transitionDuration =
        $target.css("transition-duration").indexOf("ms") >= 0
          ? parseInt($target.css("transition-duration"))
          : parseFloat($target.css("transition-duration")) * 1000;
    ...
    theme.openMobileNav = function () {
      ...
      setTimeout(function () {
        ...
        $(".mobile-navigation-drawer .lazyload--manual")
          .removeClass("lazyload--manual")
          .addClass("lazyload");
        ...
        var delayS =
          parseFloat(de.split(",")[0]) + parseFloat(du.split(",")[0]);
        setTimeout(function () {
    ...
    $(document).on("load-product-form", ".product-form", function (e) {
      ...
      $(this).on("variantChanged", function (evt, variant, product) {
        ...
        if (variant) {
          $labelCont.append(
            $(
              "#variant-label-".concat(product.id, "-").concat(variant.id)
            ).html()
          );
        } else {
          $labelCont.append(
            $("#variant-label-".concat(product.id, "-none")).html()
          );
        }
        ...
        if (variant) {
          $productDetail
            .find(".dynamic-payment-button-template")
            .each(function () {
      ...
      var $iconOptionContainers = $productDetail.find(
        ".option-selector--swatch"
      );
      if (
        $iconOptionContainers.length &&
        $("body.swatch-style-icon_circle, body.swatch-style-icon_square").length
      ) {
        $iconOptionContainers
          .find(".label")
          .append('<span class="label__value">');
      ...
      var $availabilityDependentOptions = $productDetail.find(
        '.option-selectors[data-disable-unavailable="true"]'
      );
      if ($availabilityDependentOptions.length) {
        $(this).on("variantChanged", function (evt, variant) {
          ...
          var _loop4 = function _loop4(optionIndex) {
            ...
            for (
              var _i2 = 0;
              _i2 < currentSelectedOptionValues.length && _i2 < optionIndex;
              _i2++
            ) {
            ...
            Object.keys(optionStatusMap[optionIndex].values).forEach(
              (optionValue) => {
                ...
                for (var _i3 = 0; _i3 < productData.variants.length; _i3++) {
                  ...
                  for (var j = 0; j < fixedOptionsForValue.length; j++) {
                    if (
                      fixedOptionsForValue[j] &&
                      fixedOptionsForValue[j] != _v.options[j]
                    ) {
                      // note typeless compare - can encounter (16 == '16') here
                ...
                optionStatusMap[optionIndex].values[optionValue] =
          ...
          for (var _i = 0; _i < optionStatusMap.length; _i++) {
            var _loop5 = function _loop5(optionValue) {
              $(
                ...
                .toggleClass(
                  "is-unavailable",
                  !optionStatusMap[_i].values[optionValue]
                );
              $(
            ...
            for (var optionValue in optionStatusMap[_i].values) {
              _loop5(optionValue);
            }
          }
        });
      ...
      $productFormContainer.on("change", ".option-selector", function () {
        if (
          $productFormContainer.hasClass("product-form--validation-started")
        ) {
    ...
    $(document).on(
      ...
      ".gallery",
      function (e, data, isFirstRun) {
        var $gallery = $(this);
        var $galleryCollageContainer = $gallery
          .filter(
        ...
        if ($gallery.attr("data-variant-image-grouping-option-index") !== "") {
          ...
          var pivotOptionIndex = $gallery.attr(
          ...
          if ($slideshow.hasClass("slick-slider")) {
            ...
            var currentIsVisible = !!$slideshow.find(
              '.slide[data-media-id="'.concat(data.featured_media.id, '"]')
            ).length;
          ...
          if ($thumbnails.hasClass("owl-carousel")) {
            ...
            $thumbnails
              ...
              .each(function () {
                if (
                  $(this).attr("data-variant-image-group") !=
                    selectedGroupOption &&
                  $(this).attr("data-media-id") != data.featured_media.id
                ) {
          ...
          if ($galleryCollageContainer.length) {
            ...
            $galleryCollageContainer
              .find(".slide--inactive-option")
              .appendTo($galleryCollageContainer);
          }
        }
        ...
        if ($galleryCollageContainer.length) {
          var $active = $gallery.find(
            '.slide[data-media-id="' + data.featured_media.id + '"]:first'
          );
          if ($active.length) {
    ...
    var $nonSectionedProductLists = $(
      ".product-list, .collection-listing"
    ).filter(function () {
  ...
  $(function ($) {
    ...
    if ($(".product-description_more")) {
      $(".product-description_more").click(function () {
        $(this)
          .addClass("hidden")
          .siblings(".product-description_more")
          .removeClass("hidden");
        $(".product-description").toggleClass("is-expanded");
      });
    }
    if ($(".video_button")) {
      $(".video_button").click(function () {
        const href = [...$(this)[0].classList].find((c) =>
          c.startsWith("https://www.youtube.com/")
        );
        if (href) {
          window.openVideoDialog(href);
        }
      });
    }
  });
  /** 打开视频弹窗 */
  window.openVideoDialog = function (href) {
    let url = "";
    ...
    const dialog_id = new Date().getTime();
    const dialog = `
      <div class="video_dialog" id="dialog_${dialog_id}">
        <div class="video_dialog_mask" onclick="closeDialog('${dialog_id}')"></div>
        <div class="video_dialog_wrap">
        <div class="video_dialog_close" onclick="closeDialog('${dialog_id}')">
          <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="48" height="48"><path fill="currentColor" d="M544.448 499.2l284.576-284.576a32 32 0 0 0-45.248-45.248L499.2 453.952 214.624 169.376a32 32 0 0 0-45.248 45.248l284.576 284.576-284.576 284.576a32 32 0 0 0 45.248 45.248l284.576-284.576 284.576 284.576a31.904 31.904 0 0 0 45.248 0 32 32 0 0 0 0-45.248L544.448 499.2z" ></path></svg>
        </div>
        <iframe class="video_dialog_content" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen" loading="lazy" aspect-ratio="1.77" src="${url}?controls=1&amp;enablejsapi=1&amp;loop=0&amp;modestbranding=1&amp;origin=${encodeURIComponent(
...
/** 产品页导航 */
$(function () {
  // var isProductPage = window.location.href.indexOf("products");  
  // if (isProductPage == -1) return;  
  var body = $("div[data-pf-type='Layout']");
  if (!body) return;
  const list = body.find("div[data-pf-type='Section'][id]");
  ...
  list.each((index, el) => {
    ...
    menuHtml+=`
    <div class="product_menu_item" data-id="${sectionId}" data-index="${index}" href="#${id}">${id}</div>`
  });  
  if(!menuHtml.trim()) return 
  const template = `
    <div class="product_nav" style="--top:0px">
      <div class="product_nav_body">
        <div class="product_side"></div>
  ...
  window.scrollSpyHandle = scrollSpy(".product_nav", {
    sectionSelector: "div[data-pf-type='Layout'] div[data-pf-type='Section'][id]",
    targetSelector: ".product_menu > .product_menu_item",
    offset: 30,
    activeClass: "active",
  });
  document.querySelectorAll('.product_menu_item')?.forEach(item=>{
    item.addEventListener('click', ()=>{
      var index = item.getAttribute('data-index')
      var target = scrollSpyHandle.sections[index];
      var top = target.offsetTop - scrollSpyHandle.options.offset;
      $('html, body').animate({
        scrollTop: top
      }, 300);
    })
